...
public class DMGUI extends JFrame implements ActionListener {
	...
	public DMGUI(GameServer server) {
		...
		npcResponse = new JLabel("NPC Response:");
		flagsReq = new JLabel("Flags Required:");
		flagsGive = new JLabel("Flags Given:");
		existingOptions = new JLabel("Existing Options:");
		baseDialog = new JLabel("Base Dialog:");
		directory = new JLabel("Top");
		new JLabel("Width: ");
		new JLabel("Height: ");
		new JTextField();
		new JTextField();
		...
		npcData.add(npcCha);
		npcData.add(addNpc);
		npcData.add(playerResponseField);
		npcData.add(npcResponseField);
		npcData.add(flagReqField);
		npcData.add(baseDialogField);
		npcData.add(flagsGiven);
		npcData.add(addSpeechOpt);
		npcData.add(optRemove);
		npcData.add(optEdit);
		npcData.add(optRemoveAll);
		npcData.add(optGoInto);
		npcData.add(flags);
		npcData.add(playerResponse);
		npcData.add(npcResponse);
		npcData.add(flagsReq);
		npcData.add(flagsGive);
		npcData.add(existingOptions);
		npcData.add(baseDialog);
		npcData.add(directory);
		...
		playerResponse.setLocation(300,10);
		playerResponse.setSize(200, 40);
		playerResponseField.setLocation(475,10);
		playerResponseField.setSize(140, 40);
		npcResponse.setLocation(300,80);
		npcResponse.setSize(200, 40);
		npcResponseField.setLocation(475,80);
		npcResponseField.setSize(140, 40);
		flagsReq.setLocation(300,150);
		flagsReq.setSize(200, 40);
		flagReqField.setLocation(475,150);
		flagReqField.setSize(140, 40);
		flagsGive.setLocation(300,220);
		flagsGive.setSize(200, 40);
		flagsGiven.setLocation(300, 260);
		flagsGiven.setSize(200, 100);
		flagsGiven.setBackground(flagReqField.getBackground());
		flagsGiven.setForeground(flagReqField.getForeground());
		addSpeechOpt.setLocation(300, 370);
		addSpeechOpt.setSize(200, 40);
		directory.setLocation(650, 10);
		directory.setSize(140, 40);
		baseDialog.setLocation(650, 70);
		baseDialog.setSize(140, 40);
		baseDialogField.setLocation(780, 70);
		baseDialogField.setSize(140, 40);
		existingOptions.setLocation(650, 110);
		existingOptions.setSize(200, 40);
		flags.setBackground(flagReqField.getBackground());
		flags.setForeground(flagReqField.getForeground());
		flags.setLocation(650, 140);
		flags.setSize(250, 150);
		optRemove.setLocation(650, 300);
		optRemove.setSize(150, 40);
		optEdit.setLocation(650, 350);
		optEdit.setSize(150, 40);
		optRemoveAll.setLocation(650, 400);
		optRemoveAll.setSize(150, 40);
		optGoInto.setLocation(650, 450);
		optGoInto.setSize(150, 40);
